...
class Options(Options_Parent):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--data_dir',     type=str, default='/home/chris/Documents/data/', help='chooses what datasets are loaded.')
        ...
        parser.add_argument('--mode',       type=str, default='store', help='batch size')
        ...
        parser.add_argument('--save_folder', type=str, default='/home/chris/Documents/checkpoints/', help='')
