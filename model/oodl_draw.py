...
def oodl_draw(visimg_id, pts, imgid, img=None, edges=None, vecs=None, groupids=None, draw_obj=False, match_edge_grp_color=False, max=32, linewidths=0.01, dpi=300):
    '''
    ...
    if draw_obj or (edges is not None) or (vecs is not None) or (groupids is not None):
